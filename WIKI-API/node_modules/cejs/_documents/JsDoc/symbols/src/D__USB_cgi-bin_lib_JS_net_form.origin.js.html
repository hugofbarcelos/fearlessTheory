...
<span class='line'>188</span> autocomplete: 假如所有備取 list 都有一樣的 prefix，則自動完成。
<span class='line'>189</span> 	把後面的用反白自動完成。
<span class='line'>190</span> 
<span class='line'>191</span> 在 list 上下安排三角，onmouseover 即可自動滾動。
...
<span class='line'>233</span> </span><span class="COMM">/*	可紀錄的 set class name，不過對大多數人來說，更常用的是 instance.setClassName
...
<span class='line'>345</span> </span><span class="WHIT">   </span><span class="COMM">//if(!o.getAttribute)throw 1;	IE 可用 getAttribute，FF 或許在 appendChild 之後屬性重設?，得用 o.sIndex</span><span class="WHIT">
...
<span class='line'>462</span> </span><span class="WHIT"> </span><span class="COMM">//	因為允許傳入 list，所以不能在這邊用 _t.setAllList() 判別函數，而得要寫一個泛用的。</span><span class="WHIT">
...
<span class='line'>768</span> </span><span class="COMM">//	應該盡量把東西放在 class，instance少一點？</span><span class="WHIT">
...
<span class='line'>805</span> </span><span class="COMM">//	自動於有 list 時 show arrow，無時 hide</span><span class="WHIT">
...
<span class='line'>808</span> </span><span class="COMM">//	設定要顯現的 list，會回傳 list，需注意可能被更改！</span><span class="WHIT">
...
<span class='line'>1328</span> </span><span class="WHIT"> </span><span class="KEYW">for</span><span class="PUNC">(</span><span class="NAME">i</span><span class="WHIT"> </span><span class="KEYW">in</span><span class="WHIT"> </span><span class="NAME">a</span><span class="PUNC">)</span><span class="NAME">cityL</span><span class="PUNC">[</span><span class="NAME">i</span><span class="PUNC">]</span><span class="PUNC">=</span><span class="NAME">a</span><span class="PUNC">[</span><span class="NAME">i</span><span class="PUNC">]</span><span class="PUNC">;</span><span class="WHIT">	</span><span class="COMM">//	將不常用（沒district）的放後面</span><span class="WHIT">
...
<span class='line'>1341</span> </span><span class="COMM">//	應該盡量把東西放在 class，instance少一點…？</span><span class="WHIT">
...
<span class='line'>1348</span> </span><span class="COMM">//	** important ** 這邊不能作 object 之 initialization，否則因為 object 只會 copy reference，因此 new 時東西會一樣。initialization 得在 _() 中作！</span><span class="WHIT">
