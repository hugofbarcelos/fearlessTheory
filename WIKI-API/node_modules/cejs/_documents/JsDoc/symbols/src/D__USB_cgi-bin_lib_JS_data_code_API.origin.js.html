...
<span class='line'>226</span> </span><span class="WHIT">		</span><span class="KEYW">if</span><span class="WHIT"> </span><span class="PUNC">(</span><span class="PUNC">!</span><span class="NAME">_f.noAsk</span><span class="WHIT"> </span><span class="PUNC">&&</span><span class="WHIT"> </span><span class="NAME">confirm</span><span class="PUNC">(</span><span class="STRN">'使用本功能必須安裝 Google Gears，請問您要安裝嗎？'</span><span class="PUNC">)</span><span class="PUNC">)</span><span class="WHIT">
...
<span class='line'>309</span> 驗證的程式叫 GValidateKey，是定義在 main.js，但呼叫的動作是寫在 maps.js 裡
...
<span class='line'>442</span> 		 * 2008/7/15 20:40:49	但幾天前起 GClientGeocoder 需要。而在 Firefox，即使在 file:// 也不可行??
